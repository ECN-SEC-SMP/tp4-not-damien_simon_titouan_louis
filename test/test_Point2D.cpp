...
TEST(Point2DTest, CopyConstructor) {
    Point2D<int> p1(5, 5);
...
TEST(Point2DTest, SettersWorkCorrectly) {
    Point2D<int> p; 
    p.setX(42);
    p.setY(-10);
...
TEST(Point2DTest, FullTranslation) {
    Point2D<int> p(0, 0);
    p.translate(100, 50);
...
TEST(Point2DTest, WorksWithDouble) {
